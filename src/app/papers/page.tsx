        ...
        {papers.map((paper, index) => (
          ...
          >
            <div className="flex flex-wrap gap-2 mb-3">
              <span className="inline-block bg-[var(--color-accent)] text-white px-3 py-1 rounded-full text-sm font-medium">
                {paper.year}
              </span>
              <span className="inline-block bg-[var(--color-bg)] text-[var(--color-text)] border border-[var(--color-border)] px-3 py-1 rounded-full text-sm font-medium">
                Paper
              </span>
            </div>
            ...
            <p className="text-sm text-[var(--color-accent)] mb-4 font-medium">
              {paper.conference}
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {paper.codeUrl && (
                <a
                  href={paper.codeUrl}
                  className="inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-text)] px-4 py-2 rounded-lg hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
