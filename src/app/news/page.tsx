...
const description =
  'Daily AI security news digests and weekly trend reports, generated by an automated research pipeline and curated for the topics that matter.';
    ...
    <div className="container-custom py-12 md:py-20">
      ...
      <header className="mb-10">
        ...
        <p className="text-[var(--color-text-secondary)] max-w-2xl">
          A daily digest of AI security research and a weekly trend report, produced by{' '}
          <Link href="/writing/pipeline/" className="text-[var(--color-accent)] hover:underline">
            my automated research pipeline
          </Link>{' '}
          — the same corpus my own research draws on. My hand-written work lives in{' '}
          <Link href="/writing/" className="text-[var(--color-accent)] hover:underline">
            Writing
          </Link>
          .
