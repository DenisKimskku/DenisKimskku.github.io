      ...
      <div className="text-center max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            type="button"
            onClick={() => reset()}
            className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-(--color-accent) text-white font-medium text-sm hover:opacity-90 transition-opacity focus-ring"
          >
            Try again
          </button>
          <Link
