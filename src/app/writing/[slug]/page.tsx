...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // Auto-generated content (paper reviews, digests, trend reports) is kept live but
  // de-indexed so the human-written work is the site's indexed expertise showcase.
  const AUTO_TYPES = ['Paper Review', 'News Digest', 'Trend Report'];
  const isAutoGenerated = AUTO_TYPES.includes(article.type);

  return {
    title: article.title,
    description: article.description,
    keywords: article.tags,
    robots: isAutoGenerated ? { index: false, follow: true } : undefined,
    alternates: {
