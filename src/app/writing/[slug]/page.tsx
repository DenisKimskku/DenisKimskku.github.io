  ...
  return (
    <div className="mx-auto px-6 max-[560px]:px-5 max-w-[720px] lg:max-w-[960px] py-16 md:py-24">
          ...
          <div className="flex flex-wrap gap-2">
            {normalizedTags.map((tag) => (
              <Link
                ...
                className="inline-block bg-[var(--color-bg-secondary)] text-[var(--color-text-secondary)] hover:text-[var(--color-accent)] px-3 py-1 rounded-full text-xs font-medium transition-colors"
              >
                {tag}
              </Link>
            ))}
      ...
      {article.type === 'Paper Review' && article.paperUrl && (
        <p className="-mt-6 mb-8 text-sm text-[var(--color-text-secondary)]">
          Paper:{' '}
          <a
      ...
      {isMachineGenerated && (
        <p className="-mt-4 mb-8 text-xs text-[var(--color-text-muted)]">
          ...
          <Link href="/writing/pipeline/" className="underline underline-offset-2 hover:text-[var(--color-text-secondary)]">
            how it works
          </Link>
          .
        </p>
