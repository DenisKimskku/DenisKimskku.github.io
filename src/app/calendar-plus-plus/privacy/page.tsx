  ...
  return (
    <div className="min-h-screen bg-(--color-bg)">
      <div className="container-custom py-12 md:py-20">
        <Link href="/calendar-plus-plus/" className="text-(--color-accent) hover:underline mb-8 inline-block">
          ← Back to calendar++
        </Link>

        <h1 className="text-4xl font-bold mb-8 text-(--color-text)">Privacy Policy</h1>
        <p className="text-(--color-text-secondary) mb-8">Last updated: December 21, 2025</p>

        <div className="article-content">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-(--color-text)">Introduction</h2>
            <p className="text-(--color-text) mb-4">
              calendar++ (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our macOS application.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-(--color-text) mb-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-(--color-text) mb-4 space-y-2">
              <li><a href="https://policies.google.com/privacy" className="text-(--color-accent) hover:underline" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a></li>
              <li><a href="https://policies.google.com/terms" className="text-(--color-accent) hover:underline" target="_blank" rel="noopener noreferrer">Google Terms of Service</a></li>
            </ul>
            <p className="text-(--color-text) mb-4">
              calendar++&apos;s use of information received from Google APIs adheres to the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-(--color-accent) hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Your Rights</h2>
            <p className="text-(--color-text) mb-4">You have the right to:</p>
            <ul className="list-disc list-inside text-(--color-text) mb-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-(--color-text) mb-4">
              We may update this Privacy Policy from time to time. We will notify users of any material changes by updating the &ldquo;Last updated&rdquo; date at the top of this policy.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-(--color-text) mb-4 space-y-2">
              ...
              <li>GitHub: <a href="https://github.com/DenisKimskku/Calendarpp" className="text-(--color-accent) hover:underline" target="_blank" rel="noopener noreferrer">github.com/DenisKimskku/Calendarpp</a></li>
            </ul>
          </section>
        </div>

        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <Link href="/calendar-plus-plus/" className="text-(--color-accent) hover:underline">
            ← Back to calendar++
          </Link>
        </div>
      </div>
