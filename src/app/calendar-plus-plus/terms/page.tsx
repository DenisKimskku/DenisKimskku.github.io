      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="article-content max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-(--color-text) mb-4">You may use calendar++ to:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-(--color-text) mb-4">You agree NOT to:</p>
            <ul className="list-disc list-inside text-(--color-text) mb-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-(--color-text) mb-4">
              Your use of the Application is also governed by our <Link href="/calendar-plus-plus/privacy/" className="text-(--color-accent) hover:underline">Privacy Policy</Link>. Please review it to understand our data practices.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-(--color-text) mb-4">
              calendar++ is open source software available on <a href="https://github.com/DenisKimskku/Calendarpp" className="text-(--color-accent) hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>. Contributions and modifications are subject to the repository&apos;s license terms.
            </p>
          </section>
