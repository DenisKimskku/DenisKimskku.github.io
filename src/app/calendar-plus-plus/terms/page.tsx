  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <Link href="/calendar-plus-plus" className="text-blue-600 hover:underline mb-8 inline-block">
          ← Back to calendar++
        </Link>

        <h1 className="text-4xl font-bold mb-8">Terms of Service</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">Last updated: December 21, 2025</p>
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">You may use calendar++ to:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Your use of the Application is also governed by our <Link href="/calendar-plus-plus/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>. Please review it to understand our data practices.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              calendar++ is open source software available on <a href="https://github.com/DenisKimskku/Calendarpp" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>. Contributions and modifications are subject to the repository's license terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
              ...
              <li>GitHub: <a href="https://github.com/DenisKimskku/Calendarpp" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">github.com/DenisKimskku/Calendarpp</a></li>
            </ul>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <Link href="/calendar-plus-plus" className="text-blue-600 hover:underline">
            ← Back to calendar++
          </Link>
        </div>
      </div>
