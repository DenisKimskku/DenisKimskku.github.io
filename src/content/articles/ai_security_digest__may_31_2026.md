...
The Flowise RCE exploit (CVE-2024-31309) only exacerbates this risk, showing how easily our orchestration layers are compromised. When we connect these visual pipelines to external web-retrieval systems, we are essentially building open pathways for attackers. In my prior work, [Relevance as a Vulnerability: How Web Retrieval Degrades Safety Alignment in LLM Agents](/writing/relevance_as_a_vulnerability_how_web_retrieval_degrades_safe), I detailed how the mere act of retrieving external content forces models to prioritize semantic relevance over security guardrails, directly enabling the exact indirect prompt injections highlighted by Rostova and Vance. 
