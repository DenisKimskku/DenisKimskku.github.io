...
description: "SecVecCoder uses task-vector arithmetic derived from Localized Preference Optimization (LPO) to steer LLM weights in weight-space ($W_{\\text{steered}} = W_{\\text{base}} +…"
tags: ["AI Security"]
readingTime: 9
